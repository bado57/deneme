    ...
    <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/onsenui.css">
        <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/font_awesome/css/font-awesome.min.css">
            <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/onsen-css-components-blue-basic-theme.css">
                <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/timeline.css">
                    <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/checkbox_list.css">
                        <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/shuttle-mobile-app.min.css">
                            <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/shuttle-mobile-app.css.map">
                                ...
                                <script src="<?php echo SITE_PLUGINMOGR_JS ?>/duyuruajaxquery.js"></script>
                                ...
                                <ons-navigator title="<?php echo $data["DuyuruIslem"]; ?>" var="duyuruNavigator">
                                    ...
                                    <ons-template id="duyuruyolcu.html">
                                        <ons-page id="duyuruyolcu">
                                            <input type="hidden" name="ogrAd" value=""></input>
                                            <ons-toolbar>
                                            ...
                                            <br/>
                                            <div class="settings-header" id="veliHeader" style="display:none;overflow: hidden;"><?php echo $data["Veli"]; ?> (<span id="veliToplam"></span>)</div><label class="checkbox" id="veliChechk" style="display:none;"><input type="checkbox" checked="checked" id="veliSign"><div class="checkbox__checkmark"></div></label>
                                            <ons-list id="veliList" style="display:none">
                                            </ons-list>
                                            <br />
                                            ...
                                            <div style="padding: 10px 9px; display: none" id="duyuruYzbtn">
                                                <ons-button modifier="large" style="margin: 0 auto;" onclick="$.OgrenciIslemler.ogrDuyuruSec()">
                                    ...
                                    <ons-template id="duyurugonder.html">
                                        <ons-page id="duyurugonder">
                                            ...
                                            <div style="padding: 10px 9px">
                                                <ons-button modifier="large" style="margin: 0 auto;" onclick="$.OgrenciIslemler.ogrDuyuruGonder()">
                                                    <?php echo $data["DuyuruGonder"]; ?>
                                                </ons-button>
                                            </div>
                                        </ons-page>
                                            ...
                                            <ons-bottom-toolbar>
                                                <ons-row>
                                                    ...
                                                    <ons-col width="49%" style="text-align:right;">
                                                        <button class="button button--large" onclick="$.OgrenciIslemler.duyrAyarKaydet()"><i class="fa fa-check"></i></button>
                                                    </ons-col>
                                                </ons-row>
                                            </ons-bottom-toolbar>
                                        </ons-page>
