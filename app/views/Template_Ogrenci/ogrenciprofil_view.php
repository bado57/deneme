            ...
            <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/onsen-css-components-blue-basic-theme.css">
                <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/shuttle-mobile-app.min.css">
                    <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/shuttle-mobile-app.css.map">
                        ...
                        <script src="<?php echo SITE_PLUGINMOGR_JS ?>/profilajaxquery.js"></script>
                        ...
                        <ons-navigator title="Profil" var="profileNavigator">
                            ...
                            <ons-template id="edit.html">
                                <ons-page id="editpage">
                                    <ons-toolbar>
                                        ...
                                        <div class="right"><ons-button class="resetpage" modifier="quiet" onclick="profileNavigator.resetToPage(0, {animation: 'slide'})"><i class="top-icon fa fa-home"></i></ons-button></div>
                                    </ons-toolbar>
                                    <br />
                                    ...
                                    <ons-bottom-toolbar>
                                        <ons-row>
                                            ...
                                            <ons-col width="49%" style="text-align:right;">
                                                <button class="button button--large" onclick="$.OgrenciIslemler.ogrEdtEkle()"><i class="fa fa-check"></i></button>
                                            </ons-col>
                                        </ons-row>
                                    </ons-bottom-toolbar>
                                </ons-page>
                            ...
                            <ons-template id="map.html">
                                <ons-page id="mappage">
                                    ...
                                    <div class="google-maps" id="ogr_map">
                                    </div>
                                    <ons-bottom-toolbar>
                                        <ons-row>
                                            <ons-col width="49%" style="text-align:left;">
                                            ...
                                            <ons-col width="49%" style="text-align:right;">
                                                <button class="button button--large" onclick="$.OgrenciIslemler.ogrMapSave()"><i class="fa fa-check"></i></button>
                                            </ons-col>
                                        </ons-row>
                                    </ons-bottom-toolbar>
                                </ons-page>
                                        ...
                                        <input type="password" name="eskiSifre" class="text-input--underbar" placeholder="<?php echo $data['EskiSifre']; ?>" value="">
                                            <input type="password" name="yeniSifre" class="text-input--underbar" placeholder="<?php echo $data['YeniSifre']; ?>" value="">
                                                <input type="password" name="yeniSifreTekrar" class="text-input--underbar" placeholder="<?php echo $data['YeniSifreTekrar']; ?>" value="">
                                                    ...
                                                    <div class="login-form">
                                                        <button class="button accessButton button--large" onclick="$.OgrenciIslemler.ogrSfreEkle()"><i class="fa fa-check"></i></button>
                                                        <br />
                                                        <br />
                                                        <br />
                                                        <button class="button button--large" onclick="$.OgrenciIslemler.ogrMailUnut()" style="background-color:transparent !important; border:none !important; color:#0949e2;"><?php echo $data['SifreUnut']; ?> </button>
                                                    </div>
