...
<html>
    ...
    <title>Shuttle</title>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/onsenui.css">
        <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/font_awesome/css/font-awesome.min.css">
            <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/onsen-css-components-blue-basic-theme.css">
                <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/shuttle-mobile-app.min.css">
                    <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMOGR_CSS ?>/shuttle-mobile-app.css.map">
                        <script src="<?php echo SITE_PLUGINMOGR_JS ?>/angular/angular.js"></script>
                        <script src="<?php echo SITE_PLUGINMOGR_JS ?>/jquery-2.1.4.min.js"></script>
                        <script src="<?php echo SITE_PLUGINMOGR_JS ?>/onsenui.js"></script>
                        <script src="<?php echo SITE_PLUGINMOGR_JS ?>/ogrenciajaxquery.js"></script>
                        ...
                        <ons-navigator title="Ogrenci" var="ogrenciNavigator">
                            <ons-page id="islemlistepage">
                                ...
                                <ons-list modifier="" class="edit-list">
                                    <ons-list-item modifier="chevron" onclick="ogrenciNavigator.pushPage('veliliste.html', {animation: 'slide'})">
                                        <ons-row>
                                            <ons-col width="40px">
                                                <i class="fa fa-home"></i>
                                            </ons-col>
                                            <ons-col class="coldty">
                                                <?php echo $data["VeliDetay"]; ?>
                                            </ons-col>
                                        </ons-row>
                                    </ons-list-item>
                            ...
                            <ons-template id="veliliste.html">
                                <ons-page class="kurumMain" id="veliListe" name="tMain">
                                    <ons-toolbar>
                                        <div class="left"><ons-button class="back" modifier="quiet" onclick="ogrenciNavigator.popPage()"><i class="top-icon fa fa-chevron-left"></i></ons-button></div>
                                        <div class="center"><b><i class="fa fa-home"></i> <?php echo $data["VeliListe"]; ?></b></div>
                                        <div class="right"><ons-button class="resetpage" modifier="quiet" onclick="ogrenciNavigator.resetToPage(0, {animation: 'slide'})"><i class="top-icon fa fa-home"></i></ons-button></div>
                                    </ons-toolbar>
                                    <br />
                                    <ons-list modifier="" class="settings-list" id="veliListNone">
                                        <ons-list-item>
                                            <ons-row>
                                                <ons-col width="40px">
                                                ...
                                                <ons-col class="coldty adressbar">
                                                    <span id="veliListNo"></span>
                                                </ons-col>
                                            </ons-row>
                                        </ons-list-item>
                                    </ons-list>
                                    <ons-list modifier="" class="edit-list" id="ogrVeliList" style="display:none">
                                    </ons-list>
                                    <br />
                                </ons-page>
                            </ons-template>
                            <ons-template id="veliprofilliste.html">
                                <ons-page class="profileMain" id="veliProfilListe" name="pMain">
                                    <ons-toolbar>
                                        <div class="left"><ons-button class="back" modifier="quiet" onclick="ogrenciNavigator.popPage()"><i class="top-icon fa fa-chevron-left"></i></ons-button></div>
                                    ...
                                    <ons-bottom-toolbar>
                                        <ons-row>
                                            ...
                                            <ons-col width="49%" style="text-align:right;">
                                                <button class="button button--large" onclick="$.OgrenciIslemler.bildAyarKaydet()"><i class="fa fa-check"></i></button>
                                            </ons-col>
                                        </ons-row>
                                    </ons-bottom-toolbar>
                                </ons-page>
                                ...
                                <ons-page id="haftaliktakvim">
                                    ...
                                    <ons-bottom-toolbar>
                                        <ons-row>
                                            ...
                                            <ons-col width="49%" style="text-align:right;">
                                                <button class="button button--large" onclick="$.OgrenciIslemler.hftlikTakvimKaydet()"><i class="fa fa-check"></i></button>
                                            </ons-col>
                                        </ons-row>
                                    </ons-bottom-toolbar>
                                </ons-page>
                                ...
                                <ons-page id="turbildirim">
                                    ...
                                    <ons-bottom-toolbar>
                                        <ons-row>
                                            ...
                                            <ons-col width="49%" style="text-align:right;">
                                                <button class="button button--large" onclick="$.OgrenciIslemler.turBildirimKydt()"><i class="fa fa-check"></i></button>
                                            </ons-col>
                                        </ons-row>
                                    </ons-bottom-toolbar>
                                </ons-page>
                            ...
                            <ons-template id="araclokasyon.html">
                                <ons-page id="aracLokasyon">
                                    ...
                                    <ons-toolbar>
                                        <div class="left"><ons-button class="back" modifier="quiet" onclick="$.OgrenciIslemler.anlikLocStop()"><i class="top-icon fa fa-chevron-left"></i></ons-button></div>
