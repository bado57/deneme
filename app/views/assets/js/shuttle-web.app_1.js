    ...
    if (dtype != 'svClose') {
        switch (dislemler) {
            ...
            case 'veliYeni' :
                ...
                break;
            case 'ogrenciYeni' :
                var returnCevap = $.AdminIslemler.ogrenciYeni();
                break;
            case 'adminKurumMap' :
                isMap = true;
                isSingle = false;
        ...
        switch (dislemler) {
            ...
            case 'adminEkle' :
                ...
                break;
            case 'adminDetailSil' :
                var returnCevap = $.AdminIslemler.adminDetailSil();
                break;
            case 'soforVazgec' :
                var returnCevap = $.AdminIslemler.soforVazgec();
                break;
            case 'soforEkle' :
                var returnCevap = $.AdminIslemler.soforEkle();
                break;
            case 'soforDetailSil' :
                var returnCevap = $.AdminIslemler.soforDetailSil();
                break;
            case 'isciVazgec' :
                var returnCevap = $.AdminIslemler.isciVazgec();
                break;
            case 'isciEkle' :
                var returnCevap = $.AdminIslemler.isciEkle();
                break;
            case 'isciDetailSil' :
            ...
            case 'veliDetailSil' :
                ...
                break;
            case 'ogrenciVazgec' :
                var returnCevap = $.AdminIslemler.ogrenciVazgec();
                break;
            case 'ogrenciEkle' :
                var returnCevap = $.AdminIslemler.ogrenciEkle();
                break;
            case 'ogrenciDetailSil' :
                var returnCevap = $.AdminIslemler.ogrenciDetailSil();
                break;
            default :
                $("#" + dclass).height(th);
                $("#" + dclass).css("z-index", z);
...
function editControl(edtislemler) {
    switch (edtislemler) {
        ...
        case 'adminAracDetailEdit' :
            ...
            break;
        case 'adminDetailEdit' :
            $.AdminIslemler.adminDetailDuzenle();
            break;
        case 'soforDetailEdit' :
            $.AdminIslemler.soforDetailDuzenle();
            break;
        case 'isciDetailEdit' :
        ...
        case 'veliDetailEdit' :
            ...
            break;
        case 'ogrenciDetailEdit' :
            $.AdminIslemler.ogrenciDetailDuzenle();
            break;
        default :
            break;
    }
...
function vzgControl(vzgislemler) {
    switch (vzgislemler) {
        ...
        case 'adminAracDetailVazgec' :
            ...
            break;
        case 'adminDetailVazgec' :
            $.AdminIslemler.adminDetailVazgec();
            break;
        case 'soforDetailVazgec' :
            $.AdminIslemler.soforDetailVazgec();
            break;
        ...
        case 'veliDetailVazgec' :
            ...
            break;
        case 'ogrenciDetailVazgec' :
            $.AdminIslemler.ogrenciDetailVazgec();
            break;
        default :
            break;
    }
...
function saveControl(saveislemler) {
    switch (saveislemler) {
        ...
        case 'adminDetailKaydet' :
            $.AdminIslemler.adminDetailKaydet();
            break;
        case 'soforDetailKaydet' :
            $.AdminIslemler.soforDetailKaydet();
            break;
        ...
        case 'ogrenciDetailKaydet' :
            $.AdminIslemler.ogrenciDetailKaydet();
            break;
        default :
            break;
    }
