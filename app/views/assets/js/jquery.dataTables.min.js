...
oPaginate:{sFirst:"<<",sLast:">>",sNext:">",sPrevious:"<"},sEmptyTable:"No data available in table",sInfo:"_START_ - _END_ (_TOTAL_)",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:'<i class="fa fa-search"></i>',sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
