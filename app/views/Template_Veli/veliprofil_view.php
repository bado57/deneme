            ...
            <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMVELI_CSS ?>/onsen-css-components-blue-basic-theme.css">
                <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMVELI_CSS ?>/shuttle-mobile-app.min.css">
                    <link rel="stylesheet" type="text/css" href="<?php echo SITE_PLUGINMVELI_CSS ?>/shuttle-mobile-app.css.map">
                        ...
                        <script src="<?php echo SITE_PLUGINMVELI_JS ?>/profilajaxquery.js"></script>
                        ...
                        <input type="hidden" name="veliLokasyon" value=""></input>
                                    ...
                                    <ons-bottom-toolbar>
                                        <ons-row>
                                            ...
                                            <ons-col width="49%" style="text-align:right;">
                                                <button class="button button--large" onclick="$.VeliIslemler.veliEdtEkle()"><i class="fa fa-check"></i></button>
                                            </ons-col>
                                        </ons-row>
                                    </ons-bottom-toolbar>
                                ...
                                <ons-page id="mappage">
                                    ...
                                    <ons-bottom-toolbar>
                                        <ons-row>
                                            ...
                                            <ons-col width="49%" style="text-align:right;">
                                                <button class="button button--large" onclick="$.VeliIslemler.veliMapSave()"><i class="fa fa-check"></i></button>
                                            </ons-col>
                                        </ons-row>
                                    </ons-bottom-toolbar>
                                </ons-page>
                                        ...
                                        <input type="password" name="eskiSifre" class="text-input--underbar" placeholder="<?php echo $data['EskiSifre']; ?>" value="">
                                            <input type="password" name="yeniSifre" class="text-input--underbar" placeholder="<?php echo $data['YeniSifre']; ?>" value="">
                                                <input type="password" name="yeniSifreTekrar" class="text-input--underbar" placeholder="<?php echo $data['YeniSifreTekrar']; ?>" value="">
                                                    ...
                                                    <div class="login-form">
                                                        <button class="button accessButton button--large" onclick="$.VeliIslemler.veliSfreEkle()"><i class="fa fa-check"></i></button>
                                                        <br />
                                                        <br />
                                                        <br />
                                                        <button class="button button--large" onclick="$.VeliIslemler.veliMailUnut()" style="background-color:transparent !important; border:none !important; color:#0949e2;"><?php echo $data['SifreUnut']; ?> </button>
                                                    </div>
