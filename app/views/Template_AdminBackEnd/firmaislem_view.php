                ...
                <section class="content">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group">
                                <label for="FirmaUlke">Ülke</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="FirmaAdres" class="form-control dsb" rows="3" disabled>Mevlana Mah. Turgut Özal Bulv. Talas Beğendik Karşısı.</textarea>
                            </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
