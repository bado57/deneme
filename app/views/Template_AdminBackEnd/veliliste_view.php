...
<script src="<?php echo SITE_PLUGINADMIN_AjaxJs; ?>/adminveliajaxquery.js" type="text/javascript"></script> 
<script src="<?php echo SITE_PLUGINADMIN_AjaxJs; ?>/adminveli-web.app.js" type="text/javascript"></script> 
        ...
        <div class="svContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row" id="getPartialView">
                <div class="form-vertical addKurumForm col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <input id="veliDetayAdres" name="veliDetayAdres" type="hidden" value="" />
                    <div class="form-group">
