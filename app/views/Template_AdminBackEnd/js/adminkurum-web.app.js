    ...
    if (dtype != 'svClose') {
        ...
        switch (dislemler) {
            ...
            case 'adminKurumEkle' :
                ...
                break;
            case 'adminTurVazgec' :
                var returnCevap = $.AdminIslemler.adminKurumTurVazgec();
                break;
            case 'turGidisDetailSil' :
                var returnCevap = $.AdminIslemler.kurumTurGidisDetailSil();
                break;
            case 'turDonusDetailSil' :
                var returnCevap = $.AdminIslemler.kurumTurDonusDetailSil();
                break;
            default :
                $("#" + dclass).height(th);
                $("#" + dclass).css("z-index", z);
...
function editControl(edtislemler) {
    switch (edtislemler) {
        ...
        case 'adminTurDetailEdit' :
            $.AdminIslemler.adminKurumTurDetailDuzenle();
            break;
        case 'adminTurDetailEditDonus' :
            $.AdminIslemler.adminKurumTurDetailDuzenleDonus();
            break;
        default :
            break;
    }
...
function vzgControl(vzgislemler) {
    switch (vzgislemler) {
        ...
        case 'turGidisDetailVazgec' :
            $.AdminIslemler.turKurumGidisDetailVazgec();
            break;
        case 'turDonusDetailVazgec' :
            $.AdminIslemler.turKurumDonusDetailVazgec();
            break;
        default :
            break;
    }
...
function saveControl(saveislemler) {
    switch (saveislemler) {
        case 'adminKurumDetailKaydet' :
            ...
            break;
        case 'adminKurumTurKaydet' :
            $.AdminIslemler.adminKurumTurKaydet();
            break;
        case 'turGidisDetailKaydet' :
            $.AdminIslemler.turKurumGidisDetailKaydet();
            break;
        case 'turDonusDetailKaydet' :
            $.AdminIslemler.turKurumDonusDetailKaydet();
            break;
        default :
            break;
    }
...
//tur çoklu harita
function multipleKurumTurMapping(gelen, index, ayirici, sofor) {
    /*
     * Gelen tür
     * 0->Öğrenci
     * 1->İşçi
    ...
    var sh = (hh - 50);
    $("#multiple_kurum_tur_map").height(sh);
    ...
    if (navigator.geolocation) {
        ...
        var newPos = new google.maps.LatLng(gelen[0][1],
                gelen[0][2]);
        var map = new google.maps.Map(document.getElementById('multiple_kurum_tur_map'),
                mapOptions);
        infobox = new InfoBox({
...
//tur çoklu harita
function multipleKurumHostesTurMapping(gelen, index, ayirici, hostes) {
    /*
     * Gelen tür
     * 0->Öğrenci
     * 1->İşçi
...
//tur detay harita
function multipleKurumTurDetayMap(kurumAd, kurumID, kurumLocation, soforAd, soforID, soforLocation) {
    /*
     * Gelen tür
     * 0->Öğrenci
     * 1->İşçi
    ...
    var sh = (hh - 50);
    $("#multiple_kurum_gidis_map").height(sh);
    var directionsDisplay = [];
    var directionsService = [];
    var items = new Array();
    var markerIs = new Array();
    ...
    if (navigator.geolocation) {
        ...
        map = new google.maps.Map(document.getElementById('multiple_kurum_gidis_map'),
                mapOptions);
        infobox = new InfoBox({
...
function multipleKurumTurHostesDetayMap(kurumAd, kurumID, kurumLocation, soforAd, soforID, soforLocation, hostesAd, hostesID, hostesLocation) {
    /*
     * Gelen tür
     * 0->Öğrenci
     * 1->İşçi
...
//tur detay harita
function multipleKurumTurDetayDonusMap(kurumAd, kurumID, kurumLocation, soforAd, soforID, soforLocation) {
    /*
     * Gelen tür
     * 0->Öğrenci
     * 1->İşçi
    ...
    var sh = (hh - 50);
    $("#multiple_kurum_donus_map").height(sh);
    var directionsDisplay = [];
    var directionsService = [];
    var items = new Array();
    var markerIs = new Array();
    ...
    if (navigator.geolocation) {
        ...
        var dizi = kurumLocation.split(",");
        var newPos = new google.maps.LatLng(dizi[0], dizi[1]);
        map = new google.maps.Map(document.getElementById('multiple_kurum_donus_map'),
                mapOptions);
        infobox = new InfoBox({
...
function multipleKurumTurHostesDetayDonusMap(kurumAd, kurumID, kurumLocation, soforAd, soforID, soforLocation, hostesAd, hostesID, hostesLocation) {
    /*
     * Gelen tür
     * 0->Öğrenci
     * 1->İşçi
