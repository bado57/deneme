                    ...
                    for (var i = 0; i < length; i++) {
                        ...
                        if (cevap.Bildir.ID[i] > ilkDeger) {
                            if (cevap.Bildir.Okundu[i] != 1) {//okunmadı
                                $("#bildirim").append('<li style="background-color: #ddd"><a id="bildirimIsaret" data-id="' + cevap.Bildir.ID[i] + '" data-href="' + cevap.Bildir.Url[i] + '" href="' + SITE_URL + '"AdminWeb/' + cevap.Bildir.Url[i] + '"><div class="notify-icon notify-icon-' + cevap.Bildir.Renk[i] + ' col-md-2"> <i class="' + cevap.Bildir.Icon[i] + '"></i></div><div class="notify col-md-10"><p style="margin-bottom:4px !important">' + cevap.Bildir.Text[i] + '</p><small style="text-align: right;float: right;">' + newDate + '--' + myDate[1] + '</small></div></a></li>');
                            } else {
                                $("#bildirim").append('<li><a id="bildirimIsaret" data-id="' + cevap.Bildir.ID[i] + '" data-href="' + cevap.Bildir.Url[i] + '" href=""' + SITE_URL + '"AdminWeb/' + cevap.Bildir.Url[i] + '"><div class="notify-icon notify-icon-' + cevap.Bildir.Renk[i] + ' col-md-2"> <i class="' + cevap.Bildir.Icon[i] + '"></i></div><div class="notify col-md-10"><p style="margin-bottom:4px !important">' + cevap.Bildir.Text[i] + '</p><small style="text-align: right;float: right;">' + newDate + '--' + myDate[1] + '</small></div></a></li>');
                            }
                        }
                    }
                ...
                if (cevap.hata) {
                    ...
                    if (cevap.Bildir) {
                        ...
                        for (var i = 0; i < length; i++) {
                            ...
                            if (cevap.Bildir.ID[i] < ilkDeger) {
                                if (cevap.Bildir.Okundu[i] != 1) {//okunmadı
                                    $("#bildirim").append('<li style="background-color: #ddd"><a id="bildirimIsaret" data-href="' + cevap.Bildir.Url[i] + '" data-id="' + cevap.Bildir.ID[i] + '" href=""' + SITE_URL + '"AdminWeb/' + cevap.Bildir.Url[i] + '"><div class="notify-icon notify-icon-' + cevap.Bildir.Renk[i] + ' col-md-2"> <i class="' + cevap.Bildir.Icon[i] + '"></i></div><div class="notify col-md-10"><p style="margin-bottom:4px !important">' + cevap.Bildir.Text[i] + '</p><small style="text-align: right;float: right;">' + newDate + '--' + myDate[1] + '</small></div></a></li>');
                                } else {
                                    $("#bildirim").append('<li><a id="bildirimIsaret" data-id="' + cevap.Bildir.ID[i] + '" data-href="' + cevap.Bildir.Url[i] + '"  href=""' + SITE_URL + '"AdminWeb/' + cevap.Bildir.Url[i] + '"><div class="notify-icon notify-icon-' + cevap.Bildir.Renk[i] + ' col-md-2"> <i class="' + cevap.Bildir.Icon[i] + '"></i></div><div class="notify col-md-10"><p style="margin-bottom:4px !important">' + cevap.Bildir.Text[i] + '</p><small style="text-align: right;float: right;">' + newDate + '--' + myDate[1] + '</small></div></a></li>');
                                }
                            }
