            ...
            if (kayitDeger == 0) {
                ...
                if (hostesLocation) {
                    if (diziHostesSayi != 0) {
                        ...
                        isMap = true;
                        isSingle = false;
                        multipleKurumHostesTurMapping(MultipleMapArray, MultipleMapindex, ayiriciIndex, hostes);
                        google.maps.event.addDomListener(window, 'load', multipleKurumHostesTurMapping);
                    } else {
                        var diziIndex = MultipleMapArray.length;
                        diziHostesSayi++;
                        hostes = 1;
        ...
        onChange: function (option, checked, select) {
            if (kayitDeger == 0) {
                ...
                if (hostesLocation) {
                    ...
                    google.maps.event.addDomListener(window, 'load', multipleKurumTurHostesDetayMap);
                }
            }
        }
    });
...
$.AdminIslemler = {
                                ...
                                if (turSaat1) {
                                    ...
                                    if (turSaat2) {
                                        ...
                                        if (aracID) {
                                            ...
                                            var soforID = $('select#TurSofor option[value!="-1"]:selected').val();
                                            if (soforID) {
                                                var soforAd = $("select#TurSofor option[value!='-1']:selected").attr('label');
                                                var soforLocation = $("select#TurSofor option[value!='-1']:selected").attr('location');
    ...
    adminKurumTurDetailDuzenle: function () {
        ...
        var soforID = $('select#TurDetayGidisSofor option[value!="-1"]:selected').val();
        var soforText = $('select#TurDetayGidisSofor option[value!="-1"]:selected').attr('label');
        var hostesID = $('select#TurDetayGidisHostes option[value!="-1"]:selected').val();
        var hostesText = $('select#TurDetayGidisHostes option[value!="-1"]:selected').attr('label');
