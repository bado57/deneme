...
oPaginate:{sFirst:'<i class="fa fa-angle-double-left"></i>',sLast:'<i class="fa fa-angle-double-right"></i>',sNext:'<i class="fa fa-angle-right"></i>',sPrevious:'<i class="fa fa-angle-left"></i>'},sEmptyTable:'<i class="fa fa-close"></i>',sInfo:"_START_ - _END_ (_TOTAL_)",sInfoEmpty:"",sInfoFiltered:"",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:'<i class="fa fa-bars"></i> _MENU_',sLoadingRecords:'<i class="fa fa-spinner fa-spin"></i>',sProcessing:'<i class="fa fa-spinner fa-spin"></i>',sSearch:'<i class="fa fa-search"></i>',sSearchPlaceholder:"",sUrl:"",sZeroRecords:'<i class="fa fa-close"></i>'},oSearch:h.extend({},
