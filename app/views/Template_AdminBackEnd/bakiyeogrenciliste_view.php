...
<script src="<?php echo SITE_PLUGINADMIN_AjaxJs; ?>/adminbakiyeogrenciajaxquery.js" type="text/javascript"></script> 
<script src="<?php echo SITE_PLUGINADMIN_AjaxJs; ?>/adminbakiyeogrenci-web.app.js" type="text/javascript"></script> 
    ...
    <section class="content">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <table class="table table-responsive table-bordered table-hover table-condensed" id="bakiyeOgrenciTable">
                    <thead>
                        <tr>
                    ...
                    <tbody id="ogrenciRow">
                        <?php foreach ($model as $adminModel) { ?>
                            <tr>
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title="<?php echo $data["Detay"]; ?>"
                                       value="<?php echo $adminModel['ID']; ?>">
                                        <i class="glyphicon glyphicon-user"></i> <?php echo $adminModel['Adi']; ?>
                                    </a>
                                </td>
        ...
        <div class="svContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 15px;margin-bottom: 15px;">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    <h4><i class="fa fa-graduation-cap"></i> <b id="ogrAdSoyad"></b></h4>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right:0 ">
                    <span class="pull-right">
                        <button id="addNew" type="button" class="svToggle btn btn-success addNewButton mr10" data-type="svOpen" data-class="ogrenciOdeme" data-islemler="ogrenciOdemeYeni">
                            <i class="fa fa-money"></i> <?php echo $data["YeniOdeme"]; ?></button>
                        <button data-type="svClose" data-class="OgrenciDetay" type="button" class="svToggle btn btn-danger">
...
<div id="ogrenciOdeme" class="svOpen col-lg-12 col-md-12 col-sm-12 col-xs-12 subview">
    <div class="row">
        <div class="svContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3><?php echo $data["YeniOdeme"]; ?>  ( <i class="fa fa-graduation-cap"></i> <span id="ogrOdemeAdSoyad"></span> )<span class="pull-right"><button data-type="svClose" data-class="ogrenciOdeme"  type="button" class="svToggle btn btn-danger"><i class="fa fa-times-circle"></i></button></span></h3>
            <hr/>
            <div class="row" id="getPartialView">
                <div class="form-vertical col-lg-4 col-md-4 col-sm-12 col-xs-12" method="post">
                    ...
                    <div class="form-group">
                        <button data-type="svClose"  data-class="ogrenciOdeme" type="button" data-islemler="ogrenciOdemeCancel" class="svToggle btn btn-default"><?php echo $data["Vazgec"]; ?></button>
                        <button type="button" data-type="svClose"  data-islemler="odemeKaydet" data-class="ogrenciOdeme" class="svToggle btn btn-success"><?php echo $data["Kaydet"]; ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<div id="ogrenciOdemeDuzenle" class="svOpen col-lg-12 col-md-12 col-sm-12 col-xs-12 subview">
    <div class="row">
        <div class="svContent col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <input id="rowID" name="rowID" type="hidden" value="" />
            <h3><?php echo $data["YeniOdeme"]; ?>  ( <i class="fa fa-graduation-cap"></i> <span id="ogrDOdemeAdSoyad"></span> )<span class="pull-right"><button data-type="svClose" data-class="ogrenciOdemeDuzenle"  type="button" class="svToggle btn btn-danger"><i class="fa fa-times-circle"></i></button></span></h3>
            <hr/>
            <div class="row" id="getPartialView">
                <div class="form-vertical col-lg-4 col-md-4 col-sm-12 col-xs-12" method="post">
                    <div class="form-group">
                    ...
                    <div class="form-group edit-group">
                        ...
                        <button  data-type="svClose"  data-class="ogrenciOdemeDuzenle" type="button" data-islemler="adminBakiyeDetailSil" class="btn btn-danger svToggle" ><?php echo $data["Sil"]; ?></button>
                    </div>
                </div>
            </div>
        </div>
