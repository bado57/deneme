...
//admin mobil 
define("SITE_PLUGINMADMIN_CSS", "http://192.168.1.26/SProject/app/views/Template_AdminBackEnd/MobileAdmin/css");
define("SITE_PLUGIN_MCSS", "http://192.168.1.26/SProject/app/views/Template_AdminBackEnd/MobileAdmin/css");
define("SITE_PLUGINMADMIN_FONTS", "http://192.168.1.26/SProject/app/views/Template_AdminBackEnd/MobileAdmin/font-awesome");
define("SITE_PLUGINMADMIN_JS", "http://192.168.1.26/SProject/app/views/Template_AdminBackEnd/MobileAdmin/js");
define("SITE_PLUGINM_JS", "http://192.168.1.26/SProject/app/views/assets/js");
...
//öğrenci back end
//şoför back end
define("SITE_PLUGINMSOFOR_CSS", "http://192.168.1.26/SProject/app/views/Template_Sofor/css");
define("SITE_PLUGINMSOFOR_JS", "http://192.168.1.26/SProject/app/views/Template_Sofor/js");
define("SITE_MIMG", "http://192.168.1.26/SProject/app/views/assets/img");
//işci back end
?>