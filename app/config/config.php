...
define("SITE_PLUGIN_MCSS", "http://192.168.1.22/SProject/app/views/Template_AdminBackEnd/MobileAdmin/css");
...
define("MLANGUAGE_JS", "http://192.168.1.22/SProject/app/mobilscriptlanguage/");
define("SITE_PLUGINMADMIN_AjaxJs", "http://192.168.1.22/SProject/app/views/Template_AdminBackEnd/MobileAdmin/js");
define("SITE_MPLUGIN_JS", "http://192.168.1.22/SProject/app/views/assets/js");
define("SITE_MPLUGIN_CSS", "http://192.168.1.22/SProject/app/views/assets/css");
//veli back end
//öğrenci back end
//şoför back end
define("SITE_PLUGINMSOFOR_CSS", "http://192.168.1.22/SProject/app/views/Template_Sofor/css");
define("SITE_PLUGINMSOFOR_JS", "http://192.168.1.22/SProject/app/views/Template_Sofor/js");
define("SITE_MIMG", "http://192.168.1.22/SProject/app/views/assets/img");
//işci back end
?>