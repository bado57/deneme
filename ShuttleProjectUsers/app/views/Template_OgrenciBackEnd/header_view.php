...
<html>
    <head>
        <meta charset="UTF-8">
    <title><?php echo $data["TitleOgrenci"];?>/Shuttle</title>
    <link rel="shortcut icon" href="<?php echo SITE_PLUGINADMIN_IMG; ?>/favicon.png">
        ...
        <!-- Ionicons -->
        <link href="<?php echo SITE_PLUGINADMIN_CSS; ?>/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Morris chart -->
        <link href="<?php echo SITE_PLUGINADMIN_CSS; ?>/morris/morris.css" rel="stylesheet" type="text/css" />
        <!-- jvectormap -->
        <link href="<?php echo SITE_PLUGINADMIN_CSS; ?>/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        <!-- fullCalendar -->
        <link href="<?php echo SITE_PLUGINADMIN_CSS; ?>/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css" />
        <!-- Daterange picker -->
        <link href="<?php echo SITE_PLUGINADMIN_CSS; ?>/daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo SITE_PLUGINADMIN_IMG; ?>/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo SITE_PLUGINADMIN_IMG; ?>/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
